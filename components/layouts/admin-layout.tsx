...
export function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const { useMockData, toggleMockData } = useApiConfig()
      ...
      <div className="flex h-screen">
        <Sidebar>
          ...
          <SidebarContent>
            ...
            <SidebarSeparator />
            <SidebarGroup>
              <SidebarGroupLabel>API Mode</SidebarGroupLabel>
              <SidebarGroupContent>
                <div className="px-2 py-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {useMockData ? "Currently using mock data for development" : "Currently using real backend API"}
                  </p>
                </div>
              </SidebarGroupContent>
            </SidebarGroup>
